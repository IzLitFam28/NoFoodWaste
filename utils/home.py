...
def show_home():
    ...
    # page = st_navbar(["NoFoodWaste", "Discussion Board", "Login"], styles=styles)    
    # st.write(page) 
    ...
    # st.markdown(homepage.CHEF_NAME, unsafe_allow_html=True) 
    # chef = st.selectbox("", index=0, options=["Chef Scheherazade", "Chef Giovanni"], label_visibility="hidden")
